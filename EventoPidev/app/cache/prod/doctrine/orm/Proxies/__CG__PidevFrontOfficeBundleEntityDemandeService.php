 ...
 */
class DemandeService extends \Pidev\FrontOfficeBundle\Entity\DemandeService implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\DemandeService' . "\0" . 'idOffre', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\DemandeService' . "\0" . 'idClient', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\DemandeService' . "\0" . 'etat', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\DemandeService' . "\0" . 'date');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DemandeService $proxy) {
