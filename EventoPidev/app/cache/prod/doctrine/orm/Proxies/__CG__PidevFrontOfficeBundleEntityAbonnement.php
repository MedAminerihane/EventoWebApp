 ...
 */
class Abonnement extends \Pidev\FrontOfficeBundle\Entity\Abonnement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Abonnement' . "\0" . 'id', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Abonnement' . "\0" . 'type', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Abonnement' . "\0" . 'dateDebut', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Abonnement' . "\0" . 'dateFin', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Abonnement' . "\0" . 'idPrest');
        }
