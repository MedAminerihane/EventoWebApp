...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'evento', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Pidev\\FrontOfficeBundle\\Entity'))), 'Pidev\\FrontOfficeBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('PidevFrontOfficeBundle' => 'Pidev\\FrontOfficeBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_96fef22c4be470cdcfe5fa1f41aba0dad7656225d6124599c32927069966a44e');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Pidev\\FrontOfficeBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Pidev\\FrontOfficeBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Pidev\\FrontOfficeBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Pidev\\FrontOfficeBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), 'ThisTokenIsNotSoSecretChangeIt', 'main', array('lifetime' => 604800, 'path' => '/', 'name' => 'REMEMBERME', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);
        ...
        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($e, array('target_path_parameter' => '_target_path', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b, 1 => $this->get('security.user.provider.concrete.in_memory')), 'main', $c, $d), 2 => $i, 3 => $k, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '554f628923baa', $c), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, '/login', false), NULL, NULL, $c));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('majed.aiaida@gmail.com');
        $a->setPassword('08647313');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Pidev\\FrontOfficeBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Pidev\\BackOfficeBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Google\\MapBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Pidev\\FrontOfficeBundle/Resources/views'), 'PidevFrontOffice');
        $instance->addPath(($this->targetDirs[3].'\\src\\Pidev\\BackOfficeBundle/Resources/views'), 'PidevBackOffice');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Google\\MapBundle/Resources/views'), 'GoogleMap');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PidevFrontOfficeBundle' => 'Pidev\\FrontOfficeBundle\\PidevFrontOfficeBundle',
                'PidevBackOfficeBundle' => 'Pidev\\BackOfficeBundle\\PidevBackOfficeBundle',
                ...
                'GoogleMapBundle' => 'Google\\MapBundle\\GoogleMapBundle',
            ...
            'mailer_user' => 'majed.aiaida@gmail.com',
            'mailer_password' => '08647313',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'majed.aiaida@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '08647313',
            ...
            'fos_user.model.user.class' => 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur',
