 ...
 */
class Utilisateur extends \Pidev\FrontOfficeBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur' . "\0" . 'adresse', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur' . "\0" . 'tel', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur' . "\0" . 'age', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur' . "\0" . 'cin', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur' . "\0" . 'matriculeFiscal', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur' . "\0" . 'description', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur' . "\0" . 'nature', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur' . "\0" . 'idOffre', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur' . "\0" . 'idEvenement', '' . "\0" . 'Pidev\\FrontOfficeBundle\\Entity\\Utilisateur' . "\0" . 'idClient', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setDateInscrit($dateInscrit)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateInscrit', array($dateInscrit));
    ...
    public function getDateInscrit()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDateInscrit', array());
    ...
    public function setMatriculeFiscal($matriculeFiscal)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMatriculeFiscal', array($matriculeFiscal));
    ...
    public function getMatriculeFiscal()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMatriculeFiscal', array());
    ...
    public function addIdEvenement(\Pidev\FrontOfficeBundle\Entity\Evenement $idEvenement)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addIdEvenement', array($idEvenement));

        return parent::addIdEvenement($idEvenement);
    }
    ...
    public function removeIdEvenement(\Pidev\FrontOfficeBundle\Entity\Evenement $idEvenement)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeIdEvenement', array($idEvenement));

        return parent::removeIdEvenement($idEvenement);
    }
